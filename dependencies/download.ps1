...
Download -Dependency 'System.Buffers' -TFM 'net461' -TargetTFM 'net462'
Download -Dependency 'System.Collections.Immutable' -TFM 'net461' -TargetTFM 'net462'
Download -Dependency 'System.Memory' -TFM 'net461' -TargetTFM 'net462'
Download -Dependency 'System.Numerics.Vectors' -TFM 'net46' -TargetTFM 'net462'
Download -Dependency 'System.Reflection.Metadata' -TFM 'net461' -TargetTFM 'net462'
Download -Dependency 'System.Text.Encodings.Web' -TFM 'net462' -TargetTFM 'net462'
...
Download -Dependency 'System.ValueTuple' -TFM 'net461' -TargetTFM 'net462'

Download -Dependency 'Microsoft.Bcl.AsyncInterfaces' -TFM 'netstandard2.0'
Download -Dependency 'System.Buffers' -TFM 'netstandard2.0'
Download -Dependency 'System.Collections.Immutable' -TFM 'netstandard2.0'
Download -Dependency 'System.Memory' -TFM 'netstandard2.0'
Download -Dependency 'System.Numerics.Vectors' -TFM 'netstandard2.0'
Download -Dependency 'System.Reflection.Metadata' -TFM 'netstandard2.0'
Download -Dependency 'System.Text.Encodings.Web' -TFM 'netstandard2.0'
