...
- Bump Dotnet SDK from v4.12.1 to v5.0.0 ([#69](https://github.com/getsentry/sentry-powershell/pull/69), [#71](https://github.com/getsentry/sentry-powershell/pull/71))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#500)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/4.12.1...5.0.0)
