...
- Bump Dotnet SDK from v5.4.0 to v5.13.0 ([#83](https://github.com/getsentry/sentry-powershell/pull/83), [#89](https://github.com/getsentry/sentry-powershell/pull/89))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#5130)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/5.4.0...5.13.0)
